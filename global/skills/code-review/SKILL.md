...
name: code-review
description: >-
  Automated code review with severity ranking. SOLID violations, security vulnerabilities, architectural debt.
  Triggers: "code review", "review code", "review changes", "PR review"
---
---
